    ...
    const contactInfo = [
        {
            ...
            label: 'Email',
            value: 'support@golfcharity.com.au',
            href: 'mailto:support@golfcharity.com.au'
        },
        {
            icon: (
                <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        },
        {
            ...
            label: 'Office',
            value: '123 Collins Street, Melbourne VIC 3000',
            href: 'https://maps.google.com/?q=123+Collins+Street+Melbourne'
        }
    ];
