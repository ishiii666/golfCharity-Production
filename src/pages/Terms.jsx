...
export default function Terms() {
    ...
    const fetchContent = async () => {
        try {
            ...
            const termsTitle = data.find(c => c.section_id === 'legal' && c.field_name === 'termsTitle');
            const termsDate = data.find(c => c.section_id === 'legal' && c.field_name === 'termsLastUpdated');
            const termsBody = data.find(c => c.section_id === 'legal' && c.field_name === 'termsContent');

            setContent({
                title: termsTitle?.field_value || 'Terms and Conditions',
                lastUpdated: termsDate?.field_value || '',
                body: termsBody?.field_value || ''
            });
        } catch (error) {
