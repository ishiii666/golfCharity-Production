        ...
        <AnimatePresence>
            <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
                ...
                >
                    ...
                    <div className="relative border-b border-white/[0.03] bg-white/[0.01] z-10">
                        {/* Scroll Guides */}
                        <div className="absolute left-0 top-0 bottom-0 w-8 bg-gradient-to-r from-[#0f172a] to-transparent z-20 pointer-events-none lg:hidden" />
                        <div className="absolute right-0 top-0 bottom-0 w-8 bg-gradient-to-l from-[#0f172a] to-transparent z-20 pointer-events-none lg:hidden" />

                        <div className="px-6 lg:px-10 overflow-x-auto no-scrollbar scroll-smooth">
                            <div className="flex items-center gap-4 lg:gap-8 min-w-max">
                                {[
                                    ...
                                    { id: 'security', label: 'Security & Settings', icon: 'M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.543-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z' }
                                ].map(tab => (
                                    <button
                                        key={tab.id}
                                        onClick={() => setActiveTab(tab.id)}
                                        className={`group px-1 lg:px-2 py-4 lg:py-5 text-[9px] lg:text-[10px] font-black uppercase tracking-[0.2em] lg:tracking-[0.25em] flex items-center gap-2 lg:gap-3 relative transition-all duration-300 ${activeTab === tab.id ? 'text-emerald-400' : 'text-slate-500 hover:text-slate-300'}`}
                                    >
                                        <svg className={`w-3.5 h-3.5 lg:w-4 lg:h-4 transition-all duration-500 ${activeTab === tab.id ? 'text-emerald-400' : 'group-hover:translate-y-[-2px]'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
